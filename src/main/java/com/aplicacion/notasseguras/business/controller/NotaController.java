package com.aplicacion.notasseguras.business.controller;

import com.aplicacion.notasseguras.business.entity.Nota;
import com.aplicacion.notasseguras.business.repository.NotaRepository;
...
public class NotaController {
    ...
    @PreAuthorize("hasAuthority('SAVE_ONE_NOTE')")
    @PostMapping("/notas")
    ...
    @PreAuthorize("hasAuthority('MODIFY_ONE_NOTE')")
    @PutMapping("/notas/{id}")
    ...
    @PreAuthorize("hasAuthority('DELETE_ONE_NOTE')")
